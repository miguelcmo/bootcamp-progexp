...
import CollaboratorsListSimple from "../components/CollaboratorsListSimple";
...
export default function ProjectDetails({ projectId, onBack }) {
  ...
  // Verificar si el usuario actual es el dueño del proyecto
  ...
  return (
    <div className="container py-2">
      ...
      <div className="d-flex justify-content-between align-items-start mb-3">
        <div>
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {/* Estado del proyecto - editable solo por el dueño */}
            {isProjectOwner ? (
              <div className="d-flex align-items-center gap-2">
                <label htmlFor="projectStatus" className="form-label mb-0 text-muted small">
                  Estado:
                </label>
                <select
                  id="projectStatus"
      ...
      <div className="mb-3">
        <CollaboratorsList projectId={projectId} projectOwnerId={project.user_id} />
      </div>
